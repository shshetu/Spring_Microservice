...
public class UserRatingInfoService {
    private final String MOVIE_INFO_API_FOR_INDIVIDUAL_USER = "http://rating-data-service/ratingData/users";
    @Autowired
    ...
    public UserRating getUserRating(@PathVariable("userId") String userId) {
        return restTemplate.getForObject(MOVIE_INFO_API_FOR_INDIVIDUAL_USER + "/" + userId, UserRating.class);
    }
